...
package com.oimchat.server.general.kernel.work.module.base.user.type;

/**
 * Description <br>
 * Date 2020-04-03 09:07:22<br>
 * 
 * @author XiaHui [onlovexiahui@qq.com]<br>
 * @since 1.0.0
 */

public enum UserHeadTypeEnum {
	...
	private UserHeadTypeEnum(Integer code, String text) {
		this.code = code;
		this.text = text;
	}
