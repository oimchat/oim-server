...
package com.oimchat.core.net.sender.builder;
...
import com.oimchat.core.net.sender.proxy.SendProxy;

/**
 * Description <br>
 * Date 2020-04-03 14:14:01<br>
 * 
...
public class SendBuilder {
	...
	public <T> T newInstance(Class<T> classType) {
		Object o = map.get(classType);
		if (null == o) {
			o = Proxy.newProxyInstance(classType.getClassLoader(), new Class<?>[] { classType }, proxy);
			map.put(classType, o);
		}
		return (T) o;
	}
	...
	public DataSendHandler getDataSendHandler() {
		return proxy.getDataSendHandler();
	}

	public void setDataSendHandler(DataSendHandler dataSendHandler) {
		this.proxy.setDataSendHandler(dataSendHandler);
	}
}
