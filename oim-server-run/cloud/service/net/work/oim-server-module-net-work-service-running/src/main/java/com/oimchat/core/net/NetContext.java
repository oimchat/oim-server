...
import com.oimchat.core.net.connect.SocketConnector;
...
public class NetContext {
	...
	private NetHandler netHandler = new NetHandler(connector);;
	...
	public void initialize() {
		netHandler.addConnectStatusAction(new ConnectStatusAction() {
			...
			public void onIdle(IdleStatus idleStatus) {
				if (logger.isDebugEnabled()) {
					logger.debug("idleStatus：" + idleStatus);
				}
			}
			...
			public void onAfterAutoConnect(boolean connected) {
				if (logger.isDebugEnabled()) {
					logger.debug("onAfterAutoConnect:" + connected);
				}
			}
		});
		...
		netHandler.addReceiveHandler(receiveHandler);
	}
	...
	public void setConnector(Connector connector) {
		...
		netHandler.getConnectHandler().setConnector(connector);
	}
