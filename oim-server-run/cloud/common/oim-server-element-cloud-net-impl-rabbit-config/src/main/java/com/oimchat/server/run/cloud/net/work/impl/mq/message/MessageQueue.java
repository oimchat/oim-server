...
package com.oimchat.server.run.cloud.net.work.impl.mq.message;
...
public class MessageQueue {
	...
	public static String MESSAGE_DIRECT = "oim.server.message.direct.exchange";
	public static String MESSAGE_FANOUT = "oim.server.message.fanout.exchange";

	public static String MESSAGE_FANOUT_QUEUE = "oim.server.message.fanout.queue";
}
