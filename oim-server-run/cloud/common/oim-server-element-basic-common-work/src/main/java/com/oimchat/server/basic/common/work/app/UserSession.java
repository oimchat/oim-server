...
public class UserSession {
	...
	private String remote4Address;
	private String remote6Address;
	...
	public String getRemote4Address() {
		return remote4Address;
	}

	public void setRemote4Address(String remote4Address) {
		this.remote4Address = remote4Address;
	}

	public String getRemote6Address() {
		return remote6Address;
	}

	public void setRemote6Address(String remote6Address) {
		this.remote6Address = remote6Address;
	}
}
