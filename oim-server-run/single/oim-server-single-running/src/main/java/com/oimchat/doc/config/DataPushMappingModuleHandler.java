...
/**
 * Description <br>
 * Date 2020-04-09 15:50:23<br>
 * 
 * @author XiaHui [onlovexiahui@qq.com]<br>
 * @since 1.0.0
 */

public class DataPushMappingModuleHandler extends BaseModuleHandler {

	@Override
	public boolean support(DocumentContext context, Class<?> moduleClass) {
		Annotation[] as = moduleClass.getAnnotations();
	...
	public ModuleData handle(DocumentContext context, Class<?> moduleClass) {
		Annotation[] cas = moduleClass.getAnnotations();
		Object value = ActionAnnotationUtil.getValue(MethodRequest.ActionMapping.getAnnotation(), "value", cas);
		...
		return binding(context, moduleClass, paths);
	}
}